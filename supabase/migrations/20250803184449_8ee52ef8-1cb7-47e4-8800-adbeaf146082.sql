...
SELECT 'Tiger Technology AI', 'High-tech AI solutions company focused on innovative technology development', 'Artificial Intelligence'
WHERE NOT EXISTS (SELECT 1 FROM public.companies WHERE name = 'Tiger Technology AI');
